...
class FFIntTests: XCTestCase {
    ...
    func testInitFromField() {
        let a = FFInt(UInt256(decimalString: "5"), FiniteField.PrimeField(p: 11))
...
//        a + b
    ...
    func testMultiplyBig() {
        // 2^256 - 189 is prime.
        let field = FiniteField.PrimeField(p: UInt256(hexString: "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF43"))
        
        let a = field.int(UInt256(hexString: "8888888888888888888888888888888888888888888888888888888888888888"))
       ...
       //     0x   11111111111111111111111111111111111111111111111111111111111111cd
        ...
        let product = field.int(UInt256(hexString: "11111111111111111111111111111111111111111111111111111111111111cd"))
